                    ...
                    children: [
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ///********************************* Tab Bar Headings *********************************
                            Expanded(child: Text('Transaction Id', style: AppText().headerLine6.copyWith(color: AppColor.yellow))),
                            ...
                            Expanded(child: Text('Transactor', style: AppText().headerLine6.copyWith(color: AppColor.yellow))),
                            ...
                            Expanded(child: Text('Last Balance', style: AppText().headerLine6.copyWith(color: AppColor.yellow))),
                        ...
                        children: controller.customersList.map((customer) {
                          return Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Expanded(child: Text(customer['id'] , maxLines: 2, overflow: TextOverflow.ellipsis, style: AppText().headerLine6Light.copyWith(color: AppColor.primaryBlack)),),
                                Expanded(child: Text(customer['date'], style: AppText().headerLine6Light.copyWith(color: AppColor.primaryBlack))),
                                Expanded(child: Text(customer['type'], style: AppText().headerLine6Light.copyWith(color: AppColor.primaryBlack))),
                                Expanded(child: Text(customer['transactor'], style: AppText().headerLine6Light.copyWith(color: AppColor.primaryBlack))),
                                Expanded(
                                  child: Text(
                                    customer['amount'],
                                    style: AppText().headerLine6Light.copyWith(
                                      color: double.parse(customer['amount'].replaceAll(',', '')) > 0
                                          ? AppColor.red
                                ...
                                Expanded(child: Text(customer['last_balance'], style: AppText().headerLine6Light.copyWith(color: AppColor.primaryBlack))),
